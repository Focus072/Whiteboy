...
import { getProduct, updateProduct, presignFileUpload, updateProductImage } from '@/lib/admin-api';
...
export default function EditProductPage() {
  ...
  const handleImageUpload = async (file: File) => {
    ...
    try {
      ...
      const updateResponse = await updateProductImage(productId, { imageUrl: publicUrl });
          ...
          <div>
            ...
            {formData.imageUrl && (
              <div className="mb-2 relative w-32 h-32">
                <Image src={formData.imageUrl} alt="Product" fill className="object-cover rounded-md" unoptimized />
              </div>
            )}
